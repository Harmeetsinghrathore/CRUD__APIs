...
Router.get('/api/view-all-quotes', [IS_AUTHENTICATED, IS_SUBSCRIBED, QuoteController.viewAllQuotes]);
Router.get('/api/view-a-quote/:id', [IS_AUTHENTICATED, IS_SUBSCRIBED, QuoteController.viewQuote])
