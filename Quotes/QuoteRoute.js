...
Router.post('/api/add-quote', [ QuoteController.addQuote]);
Router.get('/api/get-all-quotes', [ QuoteController.viewAllQuotes]);
Router.get('/api/get-a-quote/:id', [IS_AUTHENTICATED, IS_SUBSCRIBED, QuoteController.viewQuote])
Router.patch('/api/edit-a-quote/:id',[ QuoteController.editQuote]);
Router.delete('/api/delete-a-quote/:id', [ QuoteController.deleteQuote]);
